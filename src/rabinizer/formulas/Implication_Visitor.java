...
private static Implication_Visitor instance = new Implication_Visitor();
	...
	public boolean visitG(GOperator g, Formula fo) {
		...
		if(fo.get_id()==g.operand.get_id()){
			...
			return g.acceptBinarybool(this, ((UOperator) fo).right)||
					g.acceptBinarybool(this,FormulaFactory.mkAnd(FormulaFactory.mkG(((UOperator) fo).left),
							FormulaFactory.mkF(((UOperator) fo).right)));
