...
public class Simplify_Boolean_Visitor implements Formula_Visitor{
	
private static Simplify_Boolean_Visitor instance = new Simplify_Boolean_Visitor();
	
	private Simplify_Boolean_Visitor(){
		super();
	}
	
	public static Simplify_Boolean_Visitor getVisitor(){
		return instance;
	}
