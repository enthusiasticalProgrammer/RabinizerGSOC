...
//}
  ...
  Formula f;
    if (jj_2_7(2)) {
      ...
      f = unaryOp();
    {if (true) return FormulaFactory.mkF(f);}
    } else if (jj_2_8(2)) {
      jj_consume_token(GOP);
      f = unaryOp();
    {if (true) return FormulaFactory.mkG(f);}
    } else if (jj_2_9(2)) {
      jj_consume_token(XOP);
      f = unaryOp();
    {if (true) return FormulaFactory.mkX(f);}
    } else if (jj_2_10(2)) {
      jj_consume_token(NEG);
      f = unaryOp();
    {if (true) return FormulaFactory.mkNot(f);}
    } else if (jj_2_11(2)) {
      f = atom();
    {if (true) return f;}
    } else {
  ...
  Formula f;
    if (jj_2_12(2)) {
      jj_consume_token(TRUE);
        {if (true) return FormulaFactory.mkConst(true);}
    } else if (jj_2_13(2)) {
      jj_consume_token(FALSE);
        {if (true) return FormulaFactory.mkConst(false);}
    } else if (jj_2_14(2)) {
      atomString = jj_consume_token(ID).image;
        id = BDDForVariables.bijectionIdAtom.id(atomString);
        {if (true) return FormulaFactory.mkLit(atomString, id, false);}
    } else if (jj_2_15(2)) {
