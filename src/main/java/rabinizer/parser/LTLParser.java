...
public class LTLParser implements LTLParserConstants {
    ...
    /**
     * Parse using the previous bijection between identifiers and atoms. If
     * there is no previous bijection, create a new bijection.
     */
    public Formula parsePreviousAtoms() throws ParseException {
        if (BDDForVariables.bijectionIdAtom == null)
            BDDForVariables.bijectionIdAtom = new BijectionIdAtom();
        return formula();
    }
    ...
    final public Formula release() throws ParseException {
        Formula result;
        Formula r = null;
        result = releasewithv();
        label_4: while (true) {
    ...
    final public Formula releasewithv() throws ParseException {
        Formula result;
        Formula r = null;
        result = weak();
        label_5: while (true) {
    ...
    final public Formula weak() throws ParseException {
        Formula result;
        Formula r = null;
        result = unaryOp();
        label_6: while (true) {
