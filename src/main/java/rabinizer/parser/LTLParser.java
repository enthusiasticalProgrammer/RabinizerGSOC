...
{if ("" != null) return result;}
  ...
  final public Formula release() throws ParseException {Formula result;
  Formula r = null;
    result = releasewithv();
    label_4:
    while (true) {
...
{if ("" != null) return result;}
  ...
  final public Formula releasewithv() throws ParseException {Formula result;
  Formula r = null;
    result = weak();
    label_5:
    while (true) {
...
{if ("" != null) return result;}
  ...
  final public Formula weak() throws ParseException {Formula result;
  Formula r = null;
    result = unaryOp();
    label_6:
    while (true) {
...
{if ("" != null) return BooleanConstant.get(true);}
    } else if (jj_2_13(2)) {
      jj_consume_token(FALSE);
{if ("" != null) return BooleanConstant.get(false);}
    } else if (jj_2_14(2)) {
      atomString = jj_consume_token(ID).image;
        {if ("" != null) return FormulaFactory.mkLit(atomString, false);}
    } else if (jj_2_15(2)) {
