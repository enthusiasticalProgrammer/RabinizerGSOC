...
public class RabinPair<State> extends Tuple<TranSet<State>, TranSet<State>> {
    ...
    private static RabinPair fromSlave(RabinSlave slave, Map<FormulaState, Boolean> finalStates, int rank,
            Product product) {
         ...
         * forbidden.addAll(failP).addAll(buyP); TranSet required = new
         * TranSet(); forbidden.addAll(succeedP);
         */
