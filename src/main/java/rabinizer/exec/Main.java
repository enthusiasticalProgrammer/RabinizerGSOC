...
public class Main {
    ...
    public static AccAutomatonInterface computeAutomaton(String input, AutomatonType type, boolean computeAcc,
            boolean postfix, boolean eager, boolean simplify, boolean sinksOn, boolean relSlavesOnly, boolean optInit) {
        ...
        DTGRARaw dtgra = new DTGRARaw(formula, computeAcc, eager, sinksOn, optInit, relSlavesOnly,
