...
public class BDDEquivalenceClassTest {
    ...
    @Before
    public void setup() {
        contradiction = new Conjunction(new GOperator(new Literal("a", 1, false)),
                new FOperator(new Literal("a", 1, true)));
        tautology = new Disjunction(new XOperator(new Literal("b", 2, true)),
                new XOperator(new Literal("b", 2, false)));
