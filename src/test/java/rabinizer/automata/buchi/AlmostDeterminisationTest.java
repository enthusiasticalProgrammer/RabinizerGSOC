...
public class AlmostDeterminisationTest {
    ...
    public void testConstruction() throws ParseException {
        ...
        AlmostDeterminization det = new AlmostDeterminization(buchi);
        BuchiAutomaton semi = det.apply();
        semi.toHOA(new HOAIntermediateCheckValidity(new HOAConsumerPrint(System.out)));
