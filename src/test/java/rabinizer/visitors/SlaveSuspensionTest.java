...
public class SlaveSuspensionTest {
    ...
    public void trivialTest() {
        for (Formula patient : patientOnes) {
            Assert.assertFalse(patient.accept(visitor));
        }

        for (Formula form : suspendable) {
            Assert.assertTrue(form.accept(visitor));
        }
    ...
    public void testAnd1() {
        ...
        Assert.assertFalse(testAnd.accept(visitor));
    }

    @Test
    public void testAnd2() {
        Formula testAnd = new Conjunction(universal);
        Assert.assertTrue(testAnd.accept(visitor));
    ...
    public void testOr1() {
        ...
        Assert.assertTrue(testOr.accept(visitor));
    }
    ...
    public void testOr2() {
        ...
        Assert.assertFalse(testOr.accept(visitor));
    }
}
